...
def main() -> int:
    ...
    parser.add_argument('--width', type=int, default=1296, help='Musí odpovídat --width v main.py (výchozí 1296).')
    parser.add_argument('--height', type=int, default=972, help='Musí odpovídat --height v main.py (výchozí 972).')
